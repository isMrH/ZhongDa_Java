...
using ZDDB.BLL;
using ZDDB.Model;
public partial class AcceptShow : System.Web.UI.Page
{
    ...
    public List<AcceptTB> allInfo
    {
        get { return ViewState["allinfo"] as List<AcceptTB>; }
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        allInfo = am.GetInfoByFilter(Coname, CusName, begintime, begintime1, numbers);
        anpPage.RecordCount = allInfo.Count;
        Display();
    ...
    {
        //跳转返回
        Response.Redirect("~/AcceptandSent/Accept.aspx");
    }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (cmd == "dl")
        {
            am.DeleteAcceptTBInfo(aid);
        }
        //跳到添加或编辑页面
        else if (cmd == "ed")
        {
            Response.Redirect("~/AcceptandSent/Accept.aspx?aid=" + Convert.ToString(aid));
        }
        allInfo = am.GetAllAcceptTB();
        anpPage.RecordCount = allInfo.Count();
        Display();
    ...
    protected void imgDaochu_Click(object sender, ImageClickEventArgs e)
    {
        ...
        //Aid         CusID       Cid         CSid                 Price                 ISsettle BeginDate               Remark
        Register.Add("Nid", "编号");
