...
public partial class PriceManager_CarriageMoney_DefaultTemp : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (fulFile.HasFile)
        {
            try
            {
                ...
                message=ExeclHelper.LoadDataFromExcel1(strPath, fulFile.FileName, PriceTemplet);
