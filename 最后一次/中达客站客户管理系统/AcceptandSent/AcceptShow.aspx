<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceptShow.aspx.cs" Inherits="AcceptShow" %>
...
<div id="Wapper">
    ...
    <legend><asp:Image ID="Image1" runat="server" ImageUrl="~/images/ico06.png" 
        ...
        <div id="search1"><asp:Label ID="Label2" runat="server" Text="承运公司:"></asp:Label>
            <asp:DropDownList ID="ddlConame1" runat="server" Width="100px">
            </asp:DropDownList>
            &nbsp; 
    ...
    <div id="search2">
            <asp:GridView ID="GridView1" runat="server" CssClass="Grid"
                    ...
                    GridLines="None" Font-Size="Small" Width="740px"  
                onrowcommand="GridView1_RowCommand" Height="16px" 
                    ...
                    <asp:TemplateField HeaderText="编辑">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton3" runat="server" 
                                    CommandArgument='<%# Eval("Aid") %>' CommandName="ed" 
                                    ImageUrl="~/images/edit.gif" onclick="ImageButton3_Click" Height="15px" 
                                    Width="15px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="删除">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton4" runat="server" 
                                    ImageUrl="~/images/delete.gif" CommandName="dl" 
